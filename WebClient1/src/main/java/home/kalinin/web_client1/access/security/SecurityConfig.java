package home.kalinin.web_client1.access.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((authorize) -> authorize
                ...
                .csrf((csrf) -> csrf.ignoringRequestMatchers("/h2-console/**","/h2-console/**")) // с этим тестирование соединения проходит в н2
